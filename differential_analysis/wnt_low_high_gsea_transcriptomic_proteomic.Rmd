...
pdf(file="../supplementary_material/FigS4A.pdf", width = 25, height = 20)
set.seed(3)
...
```{r, error = TRUE, warning=FALSE, message=FALSE}
pdf(file="../supplementary_material/FigS4B.pdf", width = 25, height = 20)
set.seed(4)
...
```{r, error = TRUE, warning=FALSE, message=FALSE}
pdf(file="../supplementary_material/FigS4C.pdf", width = 15, height = 15)
set.seed(4)
...
```{r, error = TRUE, warning=FALSE, message=FALSE}
pdf(file="../supplementary_material/FigS4D.pdf", width = 25, height = 20)
set.seed(4)
...
```
```{r, error = TRUE, warning=FALSE, message=FALSE}
pdf(file="../supplementary_material/FigS4E.pdf", width = 25, height = 20)
set.seed(4)
...
```{r, error = TRUE, warning=FALSE, message=FALSE}
pdf(file="../supplementary_material/FigS4F.pdf", width = 25, height = 20)
set.seed(4)
...
```{r, error = TRUE, warning=FALSE, message=FALSE}
pdf(file="../supplementary_material/FigS4G.pdf", width = 15, height = 15)
set.seed(4)
...
```{r, error = TRUE, warning=FALSE, message=FALSE}
pdf(file="../supplementary_material/FigS4H.pdf", width = 20, height = 20)
set.seed(4)
