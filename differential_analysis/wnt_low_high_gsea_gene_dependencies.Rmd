...
save_plot("../supplementary_material/FigS3A.png", pl1, base_width = 20, base_height = 20)
save_plot("../supplementary_material/FigS3A.pdf", pl1, base_width = 20, base_height = 20)
```
...
save_plot("../supplementary_material/FigS3B.png", pl2, base_width = 25, base_height = 15)
save_plot("../supplementary_material/FigS3B.pdf", pl2, base_width = 25, base_height = 15)
```
...
save_plot("../supplementary_material/FigS3C.png", pl3, base_width = 20, base_height = 20)
save_plot("../supplementary_material/FigS3C.pdf", pl3, base_width = 20, base_height = 20)
```
...
save_plot("../supplementary_material/FigS3D.png", pl4, base_width = 19, base_height = 19)
save_plot("../supplementary_material/FigS3D.pdf", pl4, base_width = 19, base_height = 19)
```
...
save_plot("../supplementary_material/FigS3E.png", pl5, base_width = 10, base_height = 12)
save_plot("../supplementary_material/FigS3E.pdf", pl5, base_width = 10, base_height = 12)
```
...
save_plot("../supplementary_material/FigS3F.png", pl6, base_width = 20, base_height = 15)
save_plot("../supplementary_material/FigS3F.pdf", pl6, base_width = 20, base_height = 15)
```
